...
<%@include file="includes/header.jsp" %>
  ...
  <h3>Add advisor action</h3>
  <br>
  
  <form:form method="post" commandName="advisorAction">
  <spring:bind path="advisorAction.projectId">
  ...
  <br>
  <input type="submit" align="center" value="Add advisor action to project">
  </form:form>
